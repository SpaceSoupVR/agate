...
pub const BG:              Color = c(0x1E, 0x20, 0x28, 255);
pub const SURFACE:         Color = c(0x26, 0x28, 0x32, 255);
pub const SURFACE_RAISED:  Color = c(0x2E, 0x31, 0x3C, 255);
pub const BORDER:          Color = c(0x3C, 0x40, 0x4A, 255);
pub const SEPARATOR:       Color = c(0x00, 0x00, 0x00, 120);

pub const CONTROL_BG:      Color = c(0x32, 0x35, 0x3F, 255);
pub const CONTROL_HOVER:   Color = c(0x3D, 0x40, 0x4B, 255);
pub const CONTROL_ACTIVE:  Color = c(0x28, 0x2B, 0x34, 255);
...
pub const FIELD_FOCUS:     Color = c(0x0B, 0x84, 0xFF, 255);
pub const CARET:           Color = c(0xFF, 0xFF, 0xFF, 255);
pub const SELECTION_BG:    Color = c(0x3F, 0x5A, 0x8C, 220);

pub const ACCENT:          Color = c(0x0B, 0x84, 0xFF, 255);
pub const ACCENT_HI:       Color = c(0x6F, 0xB6, 0xFF, 255);
pub const ACCENT_DIM:      Color = c(0x0B, 0x84, 0xFF,  60);
...
pub const TITLEBAR_BG:     Color = c(0x1C, 0x1E, 0x24, 255);

pub const TOOLBAR_BG:      Color = c(0x22, 0x24, 0x2C, 255);

pub const SIDEBAR_BG:      Color = c(0x1A, 0x1C, 0x22, 255);

pub const STATUSBAR_BG:    Color = c(0x16, 0x18, 0x1E, 255);
